...
class WelcomeViewController: UIViewController {
	...
	@IBOutlet weak var titleLb: UILabel! {
		didSet {
			titleLb.text = String(format: NSLocalizedString("Welcome to %@", comment: "Placeholder is 'Anyone Browser'"), Bundle.main.displayName)
		}
	}
	...
	func next() {
		...
		view.sceneDelegate?.show(AnonManager.shared.checkStatus())
	}
}
