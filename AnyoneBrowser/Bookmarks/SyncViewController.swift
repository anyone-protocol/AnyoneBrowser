...
class SyncViewController: FixedFormViewController {
	...
	override func viewDidLoad() {
		...
		var desc = String(format: NSLocalizedString("If you sync, all bookmarks will be read from the server and added/updated in %@.", comment: "Placeholder is 'Anyone Browser'"), Bundle.main.displayName)
		desc += "\n\n"
		desc += String(format: NSLocalizedString("Additionally, all bookmarks not existing on the server but in %@ will be created there.", comment: "Placeholder is 'Anyone Browser'"), Bundle.main.displayName)
